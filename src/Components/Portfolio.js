  ...
  return (
    <div className="Portfolio-Container">
      ...
      <div className="About">
        <p>
          {" "}
          <span className="bout">ABOUT</span> Hi, I'm Lawal Faris, a front-end
          engineer experienced in writing clean and reusable code with the
          latest tools.
        </p>
        <p>
          My career goal is to develop processes and software tools that can
      ...
      <div className="Projects-container">
        <div className="Projects-wrapper">
          ...
          <div className="Projects-Sites">
            <a
              href="https://bricklage.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="Movies">
      ...
      <div className="Projects-container">
        <div className="Projects-wrapper">
          ...
          <div className="Projects-Sites">
            <a
              href="https://www.maritestafrica.com/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="Movies">
      ...
      <div className="Projects-container">
        <div className="Projects-wrapper">
          ...
          <div className="Projects-Sites">
            <a
              href="https://rock-bottom.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="Movies">
      ...
      <div className="Projects-container-two">
        <div className="Projects-wrapper">
          ...
          <div className="Projects-Sites">
            <a
              href="https://faris1208.github.io/Search-Engine/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="Movies">
